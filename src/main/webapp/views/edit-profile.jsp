...
<c:set var="activeTab"
	value="${not empty activeTab ? activeTab : 'profile-info'}" />
...
<body>
	...
	<div class="main-content" id="mainContent">
		...
		<div class="page-header">
			...
			<span class="badge-custom badge-premium"> <i
				class="fas fa-crown"></i> Premium User
			</span>
		</div>
			...
			<div class="col-lg-8">
				<div class="card-custom">
					...
					<ul class="nav nav-tabs-custom" role="tablist">
						<li class="nav-item"><a
							class="nav-link ${activeTab == 'profile-info' ? 'active' : ''}"
							data-bs-toggle="tab" href="#profile-info"> <i
								class="fas fa-user me-2"></i>Thông tin cá nhân
						</a></li>
						<li class="nav-item"><a
							class="nav-link ${activeTab == 'security' ? 'active' : ''}"
							data-bs-toggle="tab" href="#security"> <i
								class="fas fa-lock me-2"></i>Bảo mật
						</a></li>
						<li class="nav-item"><a
							class="nav-link ${activeTab == 'preferences' ? 'active' : ''}"
							data-bs-toggle="tab" href="#preferences"> <i
								class="fas fa-cog me-2"></i>Tùy chọn
						</a></li>
					</ul>
					...
					<div class="tab-content">
						...
						<!-- Profile Info Tab -->
						<div
							class="tab-pane fade ${activeTab == 'profile-info' ? 'show active' : ''}"
							id="profile-info">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="avatar-section">
											<c:set var="avatarUrl"
												value="${pageContext.request.contextPath}/assets/img/${sessionScope.currentUser.avatar}" />
											...
											<div class="avatar-wrapper"
												...
												<div class="avatar-overlay">
													<i class="fas fa-camera"></i> <span
														style="font-size: 0.8rem;">Thay đổi</span>
												</div>
									...
									<div class="col-md-8">
										...
										<div class="form-group-custom">
											<label class="form-label-custom"> <i
												class="fas fa-user"></i> Tên đăng nhập
											</label>
											<div class="input-group-custom">
												<i class="fas fa-at input-icon"></i> <input type="text"
													class="form-control-custom" name="username"
													value="${sessionScope.currentUser.id}" readonly>
											</div>
											<small class="text-secondary">Tên đăng nhập không thể
												thay đổi</small>
										</div>
										...
										<div class="form-group-custom">
											...
											<div class="input-group-custom">
												<i class="fas fa-envelope input-icon"></i> <input
													type="email" class="form-control-custom" name="email"
													value="${sessionScope.currentUser.email}" readonly>
											</div>
											<small class="text-secondary"> <i
												class="fas fa-check-circle text-success"></i> Đã xác thực
											</small>
										</div>

										<div class="form-group-custom">
											<label class="form-label-custom"> <i
												class="fas fa-id-card"></i> Họ và tên
											</label>
											<div class="input-group-custom">
												<i class="fas fa-signature input-icon"></i> <input
													type="text" class="form-control-custom" name="fullname"
						...
						<div
							...
							<form action="edit-profile" method="post" id="changePasswordForm">
								...
								<div class="form-group-custom">
									...
									<small class="text-secondary"> <i
										class="fas fa-info-circle"></i> Xác nhận tài khoản đang thao
										tác
									</small>
								</div>

								<div class="form-group-custom">
									<label class="form-label-custom"> <i class="fas fa-key"></i>
										Mật khẩu hiện tại
									</label>
									<div class="input-group-custom">
										<i class="fas fa-lock input-icon"></i> <input type="password"
											class="form-control-custom" name="currentPassword"
								...
								<div class="form-group-custom">
									...
									<div class="input-group-custom">
										<i class="fas fa-lock input-icon"></i> <input type="password"
											class="form-control-custom" name="newPassword"
								...
								<div class="form-group-custom">
									...
									<div class="input-group-custom">
										<i class="fas fa-lock input-icon"></i> <input type="password"
											class="form-control-custom" name="confirmPassword"
							...
							<div
								...
								<div>
									<strong>Xác thực hai yếu tố (2FA)</strong><br> <small
										class="text-secondary">Tăng cường bảo mật tài khoản</small>
								</div>
							...
							<small class="text-secondary mt-2 d-block"> <i
								class="fas fa-info-circle"></i> Chức năng đang phát triển
							</small>
						</div>

						<!-- Preferences Tab -->
						<div
							class="tab-pane fade ${activeTab == 'preferences' ? 'show active' : ''}"
							id="preferences">
							<div class="card-header-custom">
								<h3 class="card-title">
							...
							<div class="form-group-custom">
								<label class="form-label-custom"> <i
									class="fas fa-language"></i> Ngôn ngữ
								</label> <select class="form-control-custom">
							...
							<div class="form-group-custom">
								<div
									...
									style="background: #252525; border-radius: 8px;">
									<div>
										<strong>Chế độ tối</strong><br> <small
											class="text-secondary">Giao diện tối bảo vệ mắt</small>
									</div>
									<div class="form-check form-switch">
							...
							<div class="form-group-custom">
								<div
									...
									style="background: #252525; border-radius: 8px;">
									<div>
										<strong>Tự động phát video</strong><br> <small
											class="text-secondary">Phát video tiếp theo tự động</small>
									</div>
									<div class="form-check form-switch">
										<input class="form-check-input" type="checkbox" checked
											style="width: 50px; height: 25px;">
				...
				<div class="card-custom">
					...
					<div class="activity-item">
						...
						<div class="activity-content">
							...
							<div class="activity-time">Chị Là Không Có Nhau - 1 ngày
								trước</div>
						</div>
					</div>
					...
					<div class="activity-item">
						...
						<div class="activity-content">
							<div class="activity-title">Đã xem video</div>
							<div class="activity-time">TÙNG - ĐẶT TRÁI TIM LÊN BÀN - 2
								ngày trước</div>
						</div>
					</div>

					<a href="#" class="btn-custom-outline mt-3"
						style="text-align: center; display: block; padding: 0.5rem;">
